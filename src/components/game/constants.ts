...
// Seaplanes now tend to dock at marinas/piers before takeoff, so we split taxi timing.
export const SEAPLANE_PRE_DOCK_TAXI_TIME_MIN = 6; // Seconds idling/taxiing on water before docking
export const SEAPLANE_PRE_DOCK_TAXI_TIME_MAX = 14;
export const SEAPLANE_POST_DOCK_TAXI_TIME_MIN = 2; // Short taxi run after leaving dock, before takeoff
export const SEAPLANE_POST_DOCK_TAXI_TIME_MAX = 5;
export const SEAPLANE_DOCK_TIME_MIN = 4; // Seconds docked before departing
export const SEAPLANE_DOCK_TIME_MAX = 9;
export const SEAPLANE_AIR_TIME_MIN = 35; // Airborne leg duration (seconds)
export const SEAPLANE_AIR_TIME_MAX = 75;
export const SEAPLANE_LEGS_MIN = 1; // Number of airborne legs before despawn (inclusive)
export const SEAPLANE_LEGS_MAX = 2;
